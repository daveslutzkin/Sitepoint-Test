...
* `/static/index.html` that will be serverd at `localhost:3000` when the server is running
...
* We dont want to run any `npm install -g whatever` commands. **NO GLOBAL DEPENDENCIES**
* Tests are good
